...
(defgroup monica-themes nil
  "Options for monica-themes."
  :group 'faces)

(defgroup monica-purple-theme nil
  "Options for the `monica-purple' theme."
  :group 'monica-themes)

(defcustom monica-themes-padded-modeline nil
  "Default value for padded-modeline setting for themes that support it."
  :group 'monica-themes
  :type '(choice integer boolean))

(defcustom monica-themes-purple-padded-modeline monica-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'monica-purple-theme
  :type '(choice integer boolean))

(deftheme monica-purple)

(print (macroexpand '(def-doom-theme doom-shades-of-purple
...
(defmacro def-doom-theme (name docstring defs &optional extra-faces extra-vars)
  "Define a Monica theme, named NAME (a symbol)"
...
(set-frame-font (font-spec :family "Consolas" :size 14) nil t)
